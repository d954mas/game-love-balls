...
local M = {
    ...
    share_score_vk = { en = "Я получил %{score} симпатий в игре Шары Любви Аниме Девушки (vk.com/app7841255). Сможешь больше?" ..
            "\n#vkgames #directgames\"" },
}
if (CONSTANTS.IS_MAN) then
    M.share_score_vk = {
        en = "Я получил %{score} симпатий в игре Шары Любви Аниме Парни (https://vk.com/app7850847). Сможешь больше?" ..
                "\n#vkgames #directgames\""
    }
end
